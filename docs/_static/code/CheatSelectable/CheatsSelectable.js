...
if (!cheatButton) {
	...
	dropdown.innerHTML = `
		<option value="https://cdn.jsdelivr.net/gh/WestlyDust/ChoiceScript_Stats_Modifier@Main/CheatSelectable/Cheats/CheatN.js">Numbers</option>
		<option value="https://cdn.jsdelivr.net/gh/WestlyDust/ChoiceScript_Stats_Modifier@Main/CheatSelectable/Cheats/CheatB.js">Booleans</option>
		<option value="https://cdn.jsdelivr.net/gh/WestlyDust/ChoiceScript_Stats_Modifier@Main/CheatSelectable/Cheats/CheatS.js">Strings</option>
	`;
	...
	dropdown.addEventListener('change', () => {
		...
		let selectedScript = dropdown.value;
